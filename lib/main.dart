...
class _MyHomePageState extends State<MyHomePage> {
  ...
  double baseCR = 5;
  Map baseCRbylvl = {
    'yoimiya': {1: 5, 10: 5, 20: 5, 30: 5, 40: 5, 50: 9.8, 60: 14.6, 70: 14.6, 80: 19.4, 90: 24.2},
  };
...
//ANCHOR artifact5stat
  ...
  double musouisshinenergyrestoration = 0;
  double musouisshinenergyrestorationpercent = 0;
  double musouisshinenergyrestorationvalue = 0;
...
//ANCHOR ---home----calculation
  ...
  Widget build(BuildContext context) {
    ...
    enemyCryoresv = eneresbytype[enemytype]['cryo'] - (ganyuconstellation1On ? 15 : 0) - (zhonglieOn ? 20 : 0) - (manualresdebuffOn ? manualresdebuff : 0);
    if (enemyCryoresv < 0)
      ...
      case ('yoimiya'):
        {
          ...
          teikafiredancebonuspercent = yoimiyanatklvl['Teika Fire Dance Bonus'][eskilllv];
          ryukinsaxifragedmgpercent = yoimiyanatklvl['Ryukin Saxifrage DMG'][eburstlv];
      ...
      case ('ganyu'):
        {
          ...
          frostflakebloomdmgpercent = ganyunatklvl['Frostflake Arrow Bloom DMG'][natklv];

          trailoftheqilindmgpercent = ganyunatklvl['Trail of the Qilin DMG'][eskilllv];
          trailoftheqilinhppercent = ganyunatklvl['Trail of the Qilin HP'][eskilllv];
          celestialshowerdmgpercent = ganyunatklvl['Celestial Shower DMG'][eburstlv];
        }
        break;
      case ('ayaka'):
        {
      ...
      case ('raiden'):
        {
          ...
          musouisshinenergyrestoration = raidennatklvl['Musou Isshin Energy Restoration'][eburstlv];
        }
        break;
    }
    ...
    cyroplungedmgc = allatk *
        ...
        (1 + allCD / 100) *
        (1 + bonusCryoDMGpercent / 100 + bonusDMGpercent / 100 + bonusPlungeATKDMGpercent / 100) *
        (100 + level) /
        ((1 - enemydefdebuff / 100) * (100 + enemylv) + 100 + level) *
        enemyCryores;
    ...
    cyronatkalldmgnc = cyrohit1dmgnc + cyrohit2dmgnc + cyrohit3dmgnc + cyrohit4dmgnc + cyrohit5dmgnc + (cyrohit6dmgnc > 0 ? cyrohit6dmgnc : 0);

    cyronatkalldmgexp = cyrohit1dmgexp + cyrohit2dmgexp + cyrohit3dmgexp + cyrohit4dmgexp + cyrohit5dmgexp + (cyrohit6dmgexp > 0 ? cyrohit6dmgexp : 0);

    cyronatkalldmgc = cyrohit1dmgc + cyrohit2dmgc + cyrohit3dmgc + cyrohit4dmgc + cyrohit5dmgc + (cyrohit6dmgc > 0 ? cyrohit6dmgc : 0);
    ...
    yoimiyacaimdmgc = allatk *
        ...
        (1 + allCD / 100) *
        (1 + bonusPyroDMGpercent / 100 + bonusChargedATKDMGpercent / 100 + bonusDMGpercent / 100) *
        (100 + level) /
        ((1 - enemydefdebuff / 100) * (100 + enemylv) + 100 + level) *
        enemyPyrores;
                                          ...
                                          Wrap(spacing: 10, runSpacing: 10, crossAxisAlignment: WrapCrossAlignment.center, children: <Widget>[
                                            FilterChip(
                                              ...
                                              label: Text('Enlightened One:Musou Isshin Energy restoration +'.tr() +
                                                  musouisshinenergyrestorationpercent.toStringAsFixed(1) +
                                                  '%(' +
                                                  musouisshinenergyrestorationvalue.toStringAsFixed(1) +
                                                  ') & Electro DMG +'.tr() +
                              ...
                              children: [
                                ...
                                if (currentcharacter == 'ayaka')
                                  ExpansionTile(
                                    ...
                                    children: <Widget>[
                                      ...
                                      SizedBox(height: 10),
                                      builddamagebarwithcrit(
                                          Colors.black, '4-Hit Damage'.tr() + ':($hit4dmgpercent% × 3)', Colors.grey[500], Colors.grey[700], Colors.grey[900], hit4dmgnc, hit4dmgexp, hit4dmgc),
                                      SizedBox(height: 10),
                                      builddamagebarwithcrit(
                                          Colors.black, '5-Hit Damage'.tr() + ':($hit5dmgpercent%)', Colors.grey[500], Colors.grey[700], Colors.grey[900], hit5dmgnc, hit5dmgexp, hit5dmgc),
                                      SizedBox(height: 10),
                                      builddamagebarwithcrit(Colors.black, 'Charged Attack Damage'.tr() + ':($chargedattackdmgpercent% × 3)', Colors.grey[500], Colors.grey[700], Colors.grey[900],
                                ...
                                if (currentcharacter == 'ayaka')
                                  ExpansionTile(
                                      tilePadding: EdgeInsets.all(0),
                                      childrenPadding: EdgeInsets.all(0),
                                      title: builddamagebarwithcrit(Colors.black, 'Senho'.tr() + 'Charged Attack Damage'.tr() + ':($chargedattackdmgpercent% × 3)', Colors.lightBlue[200],
                                          Colors.lightBlue[400], Colors.lightBlue[600], cyrochargedatkdmgnc, cyrochargedatkdmgexp, cyrochargedatkdmgc),
                                      children: <Widget>[
                                        builddamagebarwithcrit(Colors.black, '1-Hit Damage'.tr() + ':($hit1dmgpercent%)', Colors.lightBlue[200], Colors.lightBlue[400], Colors.lightBlue[600],
                                            cyrohit1dmgnc, cyrohit1dmgexp, cyrohit1dmgc),
                                        SizedBox(height: 10),
                                        builddamagebarwithcrit(Colors.black, '2-Hit Damage'.tr() + ':($hit2dmgpercent%)', Colors.lightBlue[200], Colors.lightBlue[400], Colors.lightBlue[600],
                                            cyrohit2dmgnc, cyrohit2dmgexp, cyrohit2dmgc),
                                        SizedBox(height: 10),
                                        builddamagebarwithcrit(Colors.black, '3-Hit Damage'.tr() + ':($hit3dmgpercent%)', Colors.lightBlue[200], Colors.lightBlue[400], Colors.lightBlue[600],
                                            cyrohit3dmgnc, cyrohit3dmgexp, cyrohit3dmgc),
                                        SizedBox(height: 10),
                                        builddamagebarwithcrit(Colors.black, '4-Hit Damage'.tr() + ':($hit4dmgpercent% × 3)', Colors.lightBlue[200], Colors.lightBlue[400], Colors.lightBlue[600],
                                            cyrohit4dmgnc, cyrohit4dmgexp, cyrohit4dmgc),
                                        SizedBox(height: 10),
                                        builddamagebarwithcrit(Colors.black, '5-Hit Damage'.tr() + ':($hit5dmgpercent%)', Colors.lightBlue[200], Colors.lightBlue[400], Colors.lightBlue[600],
                                            cyrohit5dmgnc, cyrohit5dmgexp, cyrohit5dmgc),
                                        SizedBox(height: 10),
                                        builddamagebarwithcrit(Colors.black, 'Plunge Damage'.tr() + ':($plungedmgpercent%)', Colors.lightBlue[200], Colors.lightBlue[400], Colors.lightBlue[600],
                                            cyroplungedmgnc, cyroplungedmgexp, cyroplungedmgc),
                                        SizedBox(height: 10),
                                        builddamagebarwithcrit(Colors.black, 'Low Plunge Damage'.tr() + ':($lplungedmgpercent%)', Colors.lightBlue[200], Colors.lightBlue[400], Colors.lightBlue[600],
                                            cyrolplungedmgnc, cyrolplungedmgexp, cyrolplungedmgc),
                                        SizedBox(height: 10),
                                        builddamagebarwithcrit(Colors.black, 'High Plunge Damage'.tr() + ':($hplungedmgpercent%)', Colors.lightBlue[200], Colors.lightBlue[400], Colors.lightBlue[600],
                                            cyrohplungedmgnc, cyrohplungedmgexp, cyrohplungedmgc),
                                        SizedBox(height: 10),
                                        // builddamagebarwithcrit(
                                        //     Colors.red,
                                        //     'Melt'.tr() +
                                  ...
                                  ExpansionTile(
                                    ...
                                    title: builddamagebarwithcrit(
                                        ...
                                        'Musounohitotachi'.tr() +
                                            ...
                                            '+ Resolve Bounus'.tr() +
                                            ':(' +
                                            (resolveinitpercent + resolvepercent * resolvestack).toStringAsFixed(2) +
                                            '%)',
                                        Colors.purple[500],
                                        Colors.purple[700],
                                        Colors.purple[900],
